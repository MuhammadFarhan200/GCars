      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-end align-items-center mt-4">
            <a href="{{ route('pemesanan.index') }}" class="btn btn-primary me-2">Batal</a>
            @if ($pesanan->status_pesanan !== 'tertunda')
              <form action="{{ route('pemesanan.update', $pesanan->id) }}" method="post">
                ...
                <button class="btn btn-secondary me-2" type="submit">Tandai Tertunda</button>
              </form>
            @endif
            @if ($pesanan->status_pesanan !== 'diproses')
              <form action="{{ route('pemesanan.update', $pesanan->id) }}" method="post">
                ...
                <button class="btn btn-info me-2" type="submit">Tandai Diproses</button>
              </form>
            @endif
            @if ($pesanan->status_pesanan !== 'berhasil')
              <form action="{{ route('pemesanan.update', $pesanan->id) }}" method="post">
                ...
                <button class="btn btn-success me-2" type="submit">Tandai Berhasil</button>
              </form>
            @endif
