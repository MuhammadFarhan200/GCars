              ...
              <div class="wrap d-lg-flex">
                <div class="text-wrap register p-4 p-lg-5 text-center d-flex align-items-center">
                  <div class="text w-100">
                    ...
                    <p class="mb-4 text-white">Already have an account?</p>
                ...
                <div class="login-wrap register p-4 p-md-5">
                  ...
                  <form action="{{ route('register') }}" method="POST" class="signin-form">
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="name" class="form-control-auth @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name') }}" required autocomplete="off">
                      @error('name')
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="username" class="form-control-auth @error('username') is-invalid @enderror" placeholder="Username" value="{{ old('username') }}" required autocomplete="off">
                      @error('username')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="email" class="form-control-auth @error('email') is-invalid @enderror" placeholder="Email" value="{{ old('email') }}" required autocomplete="off">
                      @error('email')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="password" name="password_confirmation" class="form-control-auth" placeholder="Confirm Password" value="{{ old('password') }}" required autocomplete="off">
                    </div>
